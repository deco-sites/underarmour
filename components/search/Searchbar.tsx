...
function Searchbar({
  ...
  return (
    <div class="flex flex-col p-4 md:(py-6 px-20) bg-white max-w-[100vw]">
      <div class="flex gap-4">
        <form
          id="searchbar"
          action={action}
          class="flex-grow flex gap-3 px-3 py-2 bg-white"
        >
          <Button
            variant="icon"
            aria-label="Search"
      ...
      <div class="overflow-hidden flex flex-col gap-6 divide-y divide-default mt-6 empty:mt-0 md:(flex-row divide-y-0)">
