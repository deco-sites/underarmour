...
function Rating(
  ...
  for (let i = 0; i < 5; i++) {
    ...
    stars.push(
      ...
      >
        <polygon points="12 2 15.09 8.14 22 9.27 17 14.14 18.18 21 12 17.77 5.82 21 7 14.14 2 9.27 8.91 8.14 12 2">
        </polygon>
      </svg>,
    );
  }
  ...
  return (
    <div
      className={`flex items-center ${bigSize ? "w-[150px]" : "w-[100px]"} ` +
        className}
    >
      {stars}
      {!bigSize && (
